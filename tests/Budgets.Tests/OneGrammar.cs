...
/// ARCH-11): an environment's name and a copy's name in kernel/Target.cs, a server's protocol prefix in kernel/ServerName.cs. A second
/// copy of one lets the target grammar and estate/posture.json, or the registry and R15, read one name two ways.
/// </summary>

...
/// <summary>
/// Each grammar dbchange reads a name by is written in one file of the kernel, io and the cli (DECISIONS.md, 2026-09-25; findings R-7 and
...
/// variable's name in kernel/SqlCmd.cs. A second copy of one lets the target grammar and dbchange/environments.json, the registry and R15, or
...
public sealed class OneGrammar
{
    ...
    [InlineData(@"\Adbchange_(?<machine>", "kernel/Target.cs")]

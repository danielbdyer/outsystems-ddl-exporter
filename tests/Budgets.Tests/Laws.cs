...
public sealed class Laws
{
    ...
    public void LAWS_md_is_what_the_generators_write_from_the_tests_and_regenerates_byte_identically()
    {
        ...
        Assert.Contains("| 3′ the read is complete | The fingerprint of a read is independent of the order its elements are given in | `Estate.Kernel.Tests.ElementTests.The_fingerprint_of_a_read_is_independent_of_the_order_its_elements_are_given_in` |", text, StringComparison.Ordinal);

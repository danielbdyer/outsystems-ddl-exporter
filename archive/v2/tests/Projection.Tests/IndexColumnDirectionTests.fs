    ...
    let idxDef : IndexDef =
        {
            ...
            Filter = None
            IncludedColumns = []
            FillFactor = None; IsPadded = false; AllowRowLocks = true; AllowPageLocks = true; NoRecomputeStatistics = false; IgnoreDuplicateKey = false; IsDisabled = false; DataCompression = None; DataSpace = None
        }

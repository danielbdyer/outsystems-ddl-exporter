...
| 2026-07-02 | sweep-2 sample (s8) | quanta 2,295 / live-scan c4 2,999 / tiered 996 | after the probe-layer fusion (the only sweep-2 change on these legs): quanta drain best sample yet; ALL identity laws held again (cache, scripts, tiered, derived∘tiered). Sweep-2's derivation/composer changes live off-corpus — see PERF_OPPORTUNITIES § Sweep 2 |

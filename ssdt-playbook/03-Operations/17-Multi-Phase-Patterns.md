...
- [17.01: Explicit Type Conversion](17-Multi-Phase-Patterns/17.01-Explicit-Type-Conversion.md) — Change data types that require explicit conversion
- [17.02: NULL → NOT NULL](17-Multi-Phase-Patterns/17.02-Null-to-Not-Null.md) — Make a column required with backfill
- [17.03: Identity Property](17-Multi-Phase-Patterns/17.03-Identity-Property.md) — Add or remove IDENTITY

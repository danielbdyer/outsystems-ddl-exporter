...
| 6 | **`sidecar/projection/CLAUDE.md`** | Fresh-agent navigation (rebuilt from scratch 2026-06-11; point-don't-restate): orientation, the three-tier reading order, where-truth-lives, the survival rules, standing law one line each, the style gravities, the trigger-governed F# surface. Predecessor archived at `CLAUDE_ARCHIVE_2026_06_11.md`. | ~290 |

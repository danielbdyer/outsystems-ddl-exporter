...
| L3-S7 (Computed columns) | — | `PhysicalColumn.Computed`; `ComputedColumnConfig.create`; `encodeComputed` (A37 tolerance) | `CanaryRoundTripTests` "Slice 1.3 / L3-S7" + `AxiomTests.fs::L3-S7` | **Bucket A as of 2026-05-30 (Wave-1 slice 1.3 real-SQL leg; state + definition restored vs real SQL Server)** |

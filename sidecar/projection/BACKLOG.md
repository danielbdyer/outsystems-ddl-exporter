...
- **Wave 5 — blocked / defer-with-trigger (do NOT build speculatively):** 5.1 needs a writable UAT SQL connection (OPEN-2); 5.2–5.9 have no current consumer. IR-grows-under-evidence holds.

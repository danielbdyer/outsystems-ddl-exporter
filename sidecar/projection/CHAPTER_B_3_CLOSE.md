...
3. **Composite-PK FK extension?** Slice 1 deferred composite-PK targets as `Outcome = AmbiguousMapping`. Slice 6b's `projectTupleKeys` primitive makes this trivial (multi-column Set.difference); awaits a composite-PK fixture or consumer demand.

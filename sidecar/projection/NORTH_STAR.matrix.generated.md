...
|---|:--:|:--:|:--:|---|---|
| **Schema** | ✅ | ◑ L2-partial | ✅ | `CompositePkFkUnreflected`, `TriggerBodyUnparsedDropped` | ◑ L2-partial |
| **Data** | ✅ | ✅ faithful | ✅ | — | ✅ L3 |
...
11 named, of which **2 open** (`OpenGap`). A cell cannot be
...
_Self-reported · gate=PASS · L2 axioms live/C/D=94/10/1 · rungs L1/L2/L3=5/4/5 of 5 · tolerances 11 (2 open)_

...
| **how it ships and what the approving dev lead weighs** — the two findings (`THE_RECORD.md` §5) | "the shipping shape and the review need are these" | reproduce must yield the same delta/block; any added-scrutiny finding must survive dependency-scope |

...
*removes child rows*, possibly **chaining** through multiple tables. None material to the *publish*
(a DROP+ADD is never blocked on data) — the danger is entirely behavioural.
...
WHERE name = 'FK_<Child>_<Parent>_<Column>';
```

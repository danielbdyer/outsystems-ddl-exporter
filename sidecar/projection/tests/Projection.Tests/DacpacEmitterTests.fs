    ...
    let widget : Kind = {
        ...
        Indexes = [
            ...
            { SsKey = idxKey ["IndexedWidget"; "UQ"; "Code"]
              ...
              Columns = [ codeKey ]
              IsUnique = true; IsPrimaryKey = false; ExtendedProperties = []; Filter = None; IncludedColumns = []; IsPlatformAuto = false }
            ...
            { SsKey = idxKey ["IndexedWidget"; "IX"; "RegionLabel"]
              ...
              IsUnique = false; IsPrimaryKey = false; ExtendedProperties = []; Filter = None; IncludedColumns = []; IsPlatformAuto = false }

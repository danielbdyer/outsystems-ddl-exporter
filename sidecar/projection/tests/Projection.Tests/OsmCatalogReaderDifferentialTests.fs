    ...
    let userKind : Kind =
        { SsKey    = userKindKey
          ...
          Indexes = [
              ...
              { IRBuilders.mkIndex ixUserNameIndexKey (mkName "IX_USER_NAME") [ userIndexLastNameAttrKey; userIndexFirstNameAttrKey ] with IncludedColumns = [ userIndexEmailLowerAttrKey ] }
          ]

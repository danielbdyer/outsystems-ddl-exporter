...
- **Kleisli arrow `Pass<'a, 'b>` (chapter-Cluster-B; H-003).** Each
  ...
  unlocks H-006 (parallel composition / monoidal product), H-007
  (SchemaDelta as a second category), H-009 (multi-target fanout),
  H-063 (free monad scheduling); each extends the category with new

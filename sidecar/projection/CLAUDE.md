...
- **Data-intent / operator-intent separation (pillar 9 +
  ...
  **No parallel enumeration — true-by-construction for the pass chain**
  ...
  E1–E4 `registered ⇔ executed` isomorphism) are the named follow-up —
  they still execute via direct calls, registered as metadata only.
  5-stage `StageBinding`

# HANDOFF_ARCHIVE — prior bridge letters

Bridge letters from prior sessions, newest at top. Read these only for chronological context — the active bridge is in `HANDOFF.md`. Closed chapters' synthesis bridges live at `HANDOFF_CHAPTER_1.md` / `HANDOFF_CHAPTER_2.md`.

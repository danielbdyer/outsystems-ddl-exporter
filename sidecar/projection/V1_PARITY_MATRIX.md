...
|---|---|---|---|
| **5.1.α** | `src/Osm.Pipeline/SqlExtraction/IOutsystemsMetadataReader.cs` (all 22 DTO records) | ~100 LOC; matrix rows 11–28 | Inventories what's not-yet-lifted in V2. |

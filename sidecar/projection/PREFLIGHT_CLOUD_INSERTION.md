...
| `legacy` reverse-leg (B→A) transfer | **BUILT + WIRED** (M1.5/M3 2026-06-09; J3 closed 2026-06-10) | The 6.B.2 two-contract path (`runWithRenames`) resolves table+column rendition by SsKey against the sink contract; LE-2 canary green; contracts rendered from the one authored model (`CatalogRendition`), LE-1 rendered canary green |

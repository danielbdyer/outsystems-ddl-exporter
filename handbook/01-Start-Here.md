...
1. Go to [18. Decision Aids](#) — classify your change
2. Find your operation in [16. Operation Reference](#)
3. Follow the process in [22. The Change/Release Process](#)

### "I'm new and need to understand the basics"

1. Read this page
2. Read [2. The Big Picture](#)
3. Read [4. State-Based Modeling vs. Imperative Migrations](#)
4. Read [10. SSDT Deployment Safety](#)
...
2. Reference [14. Ownership Tiers](#) for review criteria
3. For specific operations, check [16. Operation Reference](#) for gotchas

### "Something broke and I need to fix it"

1. Go to [24. Troubleshooting Playbook](#)
2. If not covered, escalate per [25. Escalation Paths](#)
3. After resolution, add what you learned to the playbook

### "I want to improve this documentation"

1. Read [32. Contribution Guidelines](#)
2. Make your change
3. Get it reviewed
...
You'll encounter these terms immediately. Full glossary is in [30. Glossary](#).
...
- [ ] Set up local development environment (see [21. Local Development Setup](#))
...
| Escalation | See [25. Escalation Paths](#) |
| Something's broken | [24. Troubleshooting Playbook](#), then escalate |

...
1. Post-deployment script runs (populates new column)
...
1. If multi-phase: what each phase does and which release it belongs to
1. If script-only: why SSDT can't handle it declaratively

...
**Example**: M2.2 has a bug causing user FK column "CreatedBy" to skip transformation. Generated INSERT still contains orphan ID 100 (not in UAT). Deploy to UAT → FK constraint violation.

...
public sealed record SqlOptionsOverrides(
    ...
    string? AccessToken,
    int? ProfilingMaxDegreeOfParallelism,
    int? ProfilingBatchSize,
    int? ProfilingRetryCount,
    double? ProfilingRetryBaseDelaySeconds,
    double? ProfilingRetryJitterSeconds);

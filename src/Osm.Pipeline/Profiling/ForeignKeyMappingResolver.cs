...
internal sealed class ForeignKeyMappingResolver
{
        ...
        AttributeModel attribute)
    {
        ...
        var logicalName = attribute.Reference.TargetEntity?.Value ?? relationship?.TargetEntity.Value;
        var physicalName = relationship?.TargetPhysicalName.Value ?? attribute.Reference.TargetPhysicalName?.Value;

...
public sealed class DmmComparePipeline : ICommandHandler<DmmComparePipelineRequest, DmmComparePipelineResult>
{
    ...
    private PipelineBootstrapProfilingStrategy CreateProfilingStrategy(DmmComparePipelineRequest request)
    {
        return new PipelineBootstrapProfilingStrategy(
            ...
            null,
            (_, cancellationToken) => new FixtureDataProfiler(request.ProfilePath, _profileSnapshotDeserializer)

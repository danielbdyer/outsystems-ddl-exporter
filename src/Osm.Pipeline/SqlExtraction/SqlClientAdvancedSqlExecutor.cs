...
public sealed class SqlClientAdvancedSqlExecutor : IAdvancedSqlExecutor
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation(
            "Executing advanced SQL script via SQL client (timeoutSeconds: {TimeoutSeconds}, moduleCount: {ModuleCount}, includeSystem: {IncludeSystem}, includeInactive: {IncludeInactive}, onlyActive: {OnlyActive}, samplingThreshold: {SamplingThreshold}, sampleSize: {SampleSize}).",

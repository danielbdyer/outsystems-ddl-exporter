...
using static Osm.Smo.SqlFormatting;
...
public sealed class PerTableWriter
{
    ...
    private static ImmutableArray<string> BuildExtendedPropertyScripts(
        SmoTableDefinition table,
        string effectiveTableName,
        SmoFormatOptions format)
        => MsDescriptionScriptBuilder.Build(table, effectiveTableName, format);

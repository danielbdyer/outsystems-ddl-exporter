...
internal sealed record AllOfSignal : NullabilitySignal
{
    ...
    public AllOfSignal(string code, string description, IEnumerable<NullabilitySignal> signals)
    ...
    public AllOfSignal(string code, string description, params NullabilitySignal[] signals)

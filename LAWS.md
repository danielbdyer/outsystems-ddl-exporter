...
| 3′ the read is complete | Each archetype edit to the proving ground changes the fingerprint | `Estate.Io.Tests.ModelElementsTests.Each_archetype_edit_to_the_proving_ground_changes_the_fingerprint` |
...
| 3′ the read is complete | Two builds of the proving ground read into equal models and one fingerprint | `Estate.Io.Tests.ModelElementsTests.Two_builds_of_the_proving_ground_read_into_equal_models_and_one_fingerprint` |

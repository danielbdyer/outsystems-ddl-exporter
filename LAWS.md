...
| dependencies point one way | The cli references no DacFx ScriptDom or SqlClient type | `DbChange.Budgets.Tests.DependenciesPointOneWay.The_cli_references_no_DacFx_ScriptDom_or_SqlClient_type` |
...
| L1 | Every text a finding writes is in the register | `DbChange.Budgets.Tests.Register.Findings.Every_text_a_finding_writes_is_in_the_register` |

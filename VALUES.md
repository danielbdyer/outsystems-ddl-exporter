...
| L6 | Laws are tests | A law is listed in `LAWS.md`, generated from M1, only from a green test with an English name; no test skips. | `LAWS.md` generated by `ci/laws.sh` from M1; zero skip attributes | `ci/laws.sh` — pending M1; `Budgets.Tests: NoSkips` |

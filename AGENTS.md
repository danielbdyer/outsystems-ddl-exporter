...
| sqlpackage | `which sqlpackage && sqlpackage /Version` | `bash .claude/hooks/session-start.sh` (pin: `sidecar/projection/ssdt-agent/estate/toolchain.md`) |
